...
<html lang="es">
  <head>
    ...
    <style>.navbar-brand{text-shadow:0px 0px 1px yellow}a{outline:0;text-decoration:none}nav a:hover{text-shadow:0px 0px 1px yellow}.todo{font-family: 'Assistant', sans-serif;overflow:hidden;}html{scrollbar-face-color: orangered}.costado {padding:10px 30px 10px 50px}h2{padding: 30px 20px 10px 20px; color:rgb(252, 159, 84)}.todo span{width:100px}</style>
  </head>
  <body style="-moz-user-select: none; -webkit-user-select: none; -ms-user-select:none; user-select:none;-o-user-select:none;">
    ...
    <div class="todo" style="margin-left:30px">
    <h2>Editar perfil: <?php echo $usuario->username; ?></h2>
    <form style="margin-left:30px" method="POST" action="<?php echo $helper->url("usuario","actualizar"); ?>" enctype="multipart/form-data">
            ...
            <div class="row costado">
                <div class="offset-md-2">
                    <input style="margin-right:10px" value="Limpiar" type="reset" class="btn btn-outline-info">
