...
<html lang="es">
  <head>
    ...
    <style>aa{outline:0;text-decoration:none}nav a:hover{text-shadow:0px 0px 1px yellow}.todo{font-family: 'Assistant', sans-serif;overflow:hidden;}html{scrollbar-face-color: orangered}h2{padding: 30px 20px 10px 20px}#noti{width:100%}</style>
  </head>
  <body>
